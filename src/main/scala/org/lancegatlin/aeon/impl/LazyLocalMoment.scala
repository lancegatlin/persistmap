...
//
//trait LazyLocalMoment[A,+B] extends LocalMomentLike[A,B] { self =>
//
//  override lazy val materialize = {
//    MaterializedMomentLike(
//      active = active.map { case (key,record) => (key, record.materialize) }.toMap,
//      inactive = inactive
//    )
//  }
//  lazy val asMoment : MomentLike[A,B] = LiftedLocalMoment[A,B,LazyLocalMoment](this)
//}
//
